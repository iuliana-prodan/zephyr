...
#ifndef SUBSYS_MATH_XTENSA_BACKEND_PUBLIC_ZDSP_BACKEND_DSP_H_
#define SUBSYS_MATH_XTENSA_BACKEND_PUBLIC_ZDSP_BACKEND_DSP_H_
...
static inline void zdsp_scale_f32(const float32_t *src, float32_t scale, float32_t *dst,
				  uint32_t block_size)
{
	vec_scalef(dst, src, scale, block_size);
}
...
#endif /* SUBSYS_MATH_XTENSA_BACKEND_PUBLIC_ZDSP_BACKEND_DSP_H_ */
